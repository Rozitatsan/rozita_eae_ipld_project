...
min_temp_city = temps_df.loc[temps_df["AvgTemperatureCelsius"] == min_temp].iloc[0, 1]  
min_temp_date = temps_df.loc[temps_df["AvgTemperatureCelsius"] == min_temp].iloc[0, 3]  

max_temp_city = temps_df.loc[temps_df["AvgTemperatureCelsius"] == max_temp].iloc[0, 1] 
max_temp_date = temps_df.loc[temps_df["AvgTemperatureCelsius"] == max_temp].iloc[0, 3]  
...
if unique_countries_list is not None and len(selected_cities) > 0:
    ...
    for city in selected_cities:
        city_df = temps_df.loc[temps_df["City"] == city]            # TODO
